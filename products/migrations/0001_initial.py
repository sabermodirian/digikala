# Generated by Django 4.2.1 on 2025-08-22 10:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prdct_images', to='products.product', verbose_name='Product')),
            ],
            options={
                'verbose_name': 'Image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_email', models.EmailField(max_length=254, verbose_name='Email')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prdct_comments', to='products.product', verbose_name='Product')),
