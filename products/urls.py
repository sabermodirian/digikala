...
urlpatterns = [
    ...
    path('<int:product_id>/comments/', comment_api_response_drf, name='comment_api'),
  ...
  #  path('<int:product_id>/',product_detail_view, name='product_single_view'),
   ...
   # path('<int:product_id>/comments/',create_comment, name='create_comment'),
    ...
    # مسیر مخصوس یرای  لیستهای محصول در فاز  apiview
      ...
      # مسیر مخصوس یرای  لیستهای محصول در فاز  Genericapiview
      path("api_generic/products/",ProductListGenericView.as_view(), name='api-product-list'),
